...
InfluxDB::Rails.configure do |config|
    ...
    config.client.hosts = ENV["INFLUXDB_HOST"]
    config.client.port = ENV["INFLUXDB_PORT"]
    ...
    ## config.client.username = "USER NAME FOR INLFUX DATABASE"
    ## config.client.password = "USER PASSWORD FOR INLFUX DATABASE"
